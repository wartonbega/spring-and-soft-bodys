...
LabelGravite = tk.LabelFrame(window, text = 'Constante de gravitée', bg = '#2a2a2e', fg = 'white', )
...
KsSpinBox = tk.Spinbox(LabelKs, from_ = 5, to_ = 85, command = changeKs,bg = '#2a2a2e', fg = 'white', wrap = True)
KsSpinBox.pack()
